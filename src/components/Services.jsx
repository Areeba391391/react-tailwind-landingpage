...
const Services = () => {
  ...
  return (
    <section data-aos="fade-up"
     data-aos-anchor-placement="center-bottom" id="services" className="py-20 container mx-auto px-4 md:px-10 lg:px-14">
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24">
        ...
        <div className="flex flex-wrap gap-8 md:w-2/3" data-aos="fade-up"
     data-aos-anchor-placement="center-bottom">
          {services.map((service, index) => (
            <div 
              key={index}
              className="bg-white w-full sm:w-[48%] lg:w-[45%] cursor-pointer rounded-2xl p-6 hover:shadow-xl transition-shadow duration-300"
            >
              <div className="mb-4">
                {service.icon}
              </div>
